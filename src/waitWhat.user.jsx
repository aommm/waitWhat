  ...
  var ListView = React.createClass({
    ...
    render: function() {
      ...
      var filterDiv = (
        <div>
          ...
          <label><input type="checkbox" checked={this.props.filters.mergeInputEvents} onChange={this.checkboxChanged.bind(this, 'mergeInputEvents')} /> Merge input events <br/></label>
    ...
    renderListDetailsEvent: function (mutation) {
      var lis = [
        ...
        <li>Target value: {mutation.targetValue}</li>
      ];
      return lis;
    },
